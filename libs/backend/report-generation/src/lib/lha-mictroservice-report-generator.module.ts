...
import { LhaBackendReportGenerateQueueModule } from '@lighthouse-automation/backend/queue/report-generate-queue';

import { ReportSchema } from '@lighthouse-automation/backend/report';
